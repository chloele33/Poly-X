...
# input:
#   set of per-shape feature sets &
#   a feature set x corresponding to a new candidate placement
#   for all shape features, have a target value t 0 <= t <= 1, all t's are 1's if none given
#
# Learn